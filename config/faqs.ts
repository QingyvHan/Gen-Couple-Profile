...
export const FAQS_KO = [
  {
    title: "랜딩 페이지란 무엇인가요?",
    content:
      "랜딩 페이지는 마케팅 또는 광고 캠페인을 위해 특별히 제작된 독립형 웹 페이지입니다. 방문자가 이메일, Google, Bing, YouTube, Facebook, Instagram, Twitter 또는 웹의 유사한 위치에 있는 광고의 링크를 클릭한 후 '착륙'하는 곳입니다. 일반적으로 많은 목표를 가지고 탐색을 장려하는 웹 페이지와 달리 랜딩 페이지는 행동 촉구(CTA)라고 알려진 단일 초점 또는 목표로 설계되었습니다.",
  },
  {
    title: "랜딩 페이지는 어떻게 만드나요?",
    content:
      "랜딩 페이지 생성은 몇 가지 단계로 완료할 수 있습니다: 1) 캠페인의 요구 사항에 맞는 랜딩 페이지 템플릿을 선택하거나 처음부터 시작합니다. 2) 랜딩 페이지의 목표와 CTA를 식별합니다. 3) 방문자가 조치를 취하도록 촉구하는 설득력 있는 콘텐츠를 작성합니다. 4) 메시지와 일치하는 이미지, 비디오 및 양식과 같은 디자인 요소를 통합합니다. 5) 페이지의 유용성과 모바일 반응성을 테스트합니다. 6) SEO 모범 사례를 사용하여 페이지가 검색되도록 돕습니다. 7) 랜딩 페이지를 게시하고 필요에 따라 조정하기 위해 성과를 모니터링합니다.",
  },
  {
    title: "랜딩 페이지가 왜 중요한가요?",
    content:
      "랜딩 페이지는 방문자를 리드 또는 고객으로 전환하기 위한 타겟 플랫폼을 제공하기 때문에 모든 마케팅 전략에 중요합니다. 일반 웹사이트와 달리 랜딩 페이지는 방문자의 주의를 단일 제안에 집중시켜 산만함을 최소화하고 특정 행동으로 안내합니다. 이러한 집중된 접근 방식은 마케팅 캠페인의 효과를 크게 높이고 광고 성과를 개선하며 방문자가 찾고 있던 정보나 솔루션을 제공하여 전반적인 사용자 경험을 향상시킬 수 있습니다.",
  },
  {
    title: "왜 우리의 랜딩 페이지 템플릿을 선택해야 하나요?",
    content:
      "우리의 랜딩 페이지 템플릿은 무료이며 오픈 소스이고 강력하여 다양한 프로젝트와 마케팅 캠페인에 이상적입니다. 1시간 이내에 랜딩 페이지를 만들 수 있어 개발 프로세스를 단순화하는 동시에 높은 수준의 사용자 정의 및 반응성을 제공합니다.",
  },
  {
    title: "이 템플릿을 사용하는 데 어떤 기술이 필요한가요?",
    content:
      "랜딩 페이지 템플릿을 사용하려면 기본적인 웹 편집 기술만 있으면 됩니다. 템플릿의 디자인은 기술적인 사용자가 아니더라도 쉽게 시작할 수 있도록 의도되었으며 경험 많은 개발자에게도 높은 사용자 정의 가능성을 제공합니다.",
  },
  {
    title: "랜딩 페이지 템플릿을 시작하려면 어떻게 해야 하나요?",
    content:
      "시작하는 것은 매우 간단합니다. GitHub 리포지토리에서 소스 코드를 다운로드하고 필요에 따라 텍스트와 이미지를 편집한 다음 서버에 배포하기만 하면 됩니다.",
  },
  {
    title: "랜딩 페이지 템플릿은 반응형 디자인을 지원하나요?",
    content:
      "예, 랜딩 페이지 템플릿은 반응형 디자인을 지원하여 데스크톱, 태블릿, 스마트폰 등 다양한 기기에서 웹 페이지가 완벽하게 표시되도록 합니다.",
  },
  {
    title: "이 템플릿을 상업용 프로젝트에 사용할 수 있나요?",
    content:
      "물론입니다. 우리의 템플릿은 오픈 소스이며 상업적 목적을 포함한 모든 유형의 프로젝트에 사용할 수 있습니다. 사용자가 이 템플릿을 활용하여 온라인 프로젝트를 만들고 최적화하도록 권장합니다.",
  },
  {
    title: "사용자 정의 서비스를 제공하나요?",
    content:
      "우리는 랜딩 페이지의 유료 맞춤형 개발을 허용합니다. 이메일 weijunext@gmail.com 또는 Twitter @weijunext로 문의하십시오.",
  },
  {
    title: "이 템플릿을 사용하는 데 제한이 있나요?",
    content:
      "아니요. 이 템플릿을 자유롭게 사용하고 수정할 수 있습니다. 동시에 개발자가 PR을 제출하여 이 랜딩 페이지 템플릿을 함께 개선하는 것을 권장합니다.",
  },
  {
    title: "이 템플릿에는 SEO 최적화 기능이 포함되어 있나요?",
    content:
      "예, 템플릿에는 웹 페이지가 검색 엔진에서 더 나은 순위를 달성하는 데 도움이 되는 기본 SEO 최적화 기능이 포함되어 있습니다.",
  },
  {
    title: "템플릿을 사용하는 동안 문제가 발생하면 어떻게 해야 하나요?",
    content:
      "템플릿을 사용하는 동안 문제가 발생하면 Twitter @weijunext로 문의하십시오.",
  },
];
